...
const MainOrder = () => {
  return (
    <section className='mt-[60px] w-full px-[25px] xl:pl-[5px] xl:pr-[0px] flex flex-col gap-[60px]'>
      <h2 className='text-[44px] leading-[53px] font-bold text-[#000000]'>Этапы заказа</h2>
      {/* <Title2>Этапы заказа</Title2> */}
      <ul className='w-full flex flex-col md:flex-row gap-[59px] md:gap-[0px] border-l-[1px] md:border-l-[0px] md:border-t-[1px] border-[#c4c4c4]'>
